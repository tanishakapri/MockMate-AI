...
console.log("RAW from LLM:", raw);

// Extract only the JSON part (object or array)
...
const jsonStr = match[0]; // clean JSON
let parsed;
...
try {
  ...
  return; // stop here because JSON invalid
}

// =============⭐ FIXED: replace MockJsonResp with jsonStr ⭐============ //

const resp = await db
  .insert(MockInterview)
  .values({
    mockId: uuidv4(),
    jsonMockResp: jsonStr,   // ⬅⬅ HERE (your final cleaned JSON)
